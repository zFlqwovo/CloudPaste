export default {
  file: {
    ...
    uploadModes: {
      ...
      presignOnly: "(S3 Only)",
      presignMode: "Presigned Mode",
      directMode: "Direct Mode",
      presignTooltip: "Files upload directly to S3 storage without server relay",
      directTooltip: "Files upload through server relay to storage",
    },
