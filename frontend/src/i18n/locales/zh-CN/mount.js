export default {
  mount: {
    ...
    settings: {
      ...
      spacingStandard: "标准",
      spacingRelaxed: "宽松",
      fileNameDisplay: "文件名显示",
      fileNameEllipsis: "省略号截断",
      fileNameScroll: "悬停滚动",
      fileNameWrap: "自动换行",
    ...
    uppy: {
      ...
      streamModeTooltip: "通过后端流式中转上传到存储",
      formModeTooltip: "通过表单(form-data)上传到存储",
  ...
  breadcrumb: {
    navigation: "面包屑导航",
    root: "根目录",
    exitSelection: "退出勾选", // 仅保留此项，用于 FloatingActionBar
  },
};
