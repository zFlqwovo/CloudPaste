<template>
  <div class="archive-password-container p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
    <div class="text-center mb-6">
      ...
      <h3 class="text-lg font-semibold mb-2" :class="darkMode ? 'text-gray-200' : 'text-gray-800'">
        压缩文件已加密
      </h3>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      <!-- 密码输入框 -->
      <div>
        <label for="archive-password" class="block text-sm font-medium mb-2" 
        ...
        <div class="relative">
          <input
            ...
            :class="[
              darkMode 
                ...
                : 'border-gray-300 text-gray-900 focus:ring-offset-white',
          ...
          <button
            ...
            :disabled="isValidating"
          >
            <svg class="w-5 h-5" :class="darkMode ? 'text-gray-400' : 'text-gray-500'" 
      ...
      <div class="flex space-x-3 pt-4">
        ...
        <button
          ...
          :class="[
            darkMode 
              ? 'text-gray-300 hover:bg-gray-700 focus:ring-offset-gray-800' 
              : 'text-gray-700 hover:bg-gray-50 focus:ring-offset-white'
          ]"
        >
          取消
        </button>
